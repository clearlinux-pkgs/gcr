...
%prep
%setup -q -n gcr-3.36.0
cd %{_builddir}/gcr-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585695435
...
cp %{_builddir}/gcr-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/gcr/5fb362ef1680e635fe5fb212b55eef4db9ead48f
