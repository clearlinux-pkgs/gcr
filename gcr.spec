...
Source0  : https://download.gnome.org/sources/gcr/3.34/gcr-3.34.0.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571141010
...
cp %{_builddir}/gcr-3.34.0/COPYING %{buildroot}/usr/share/package-licenses/gcr/5fb362ef1680e635fe5fb212b55eef4db9ead48f
%make_install
%find_lang gcr
