...
Source0  : https://download.gnome.org/sources/gcr/3.38/gcr-3.38.1.tar.xz
...
%prep
%setup -q -n gcr-3.38.1
cd %{_builddir}/gcr-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611251749
...
cp %{_builddir}/gcr-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/gcr/5fb362ef1680e635fe5fb212b55eef4db9ead48f
